...
<Tabs groupId="agents">
    <TabItem value="cli" label="Agentic CLI for AKS">
        ...
        ### Step 5: Enabling/Deploying Inspetor Gadget
...
<Tabs groupId="agents">
    <TabItem value="cli" label="Agentic CLI for AKS">
        ...
        :::note
        **Prerequisite:** This feature requires [Inspektor Gadget](https://github.com/inspektor-gadget/inspektor-gadget) to be installed in your cluster. If you haven't already, complete [Step 5: Enabling/Deploying Inspektor Gadget](#step-5-enablingdeploying-inspetor-gadget) before proceeding.
        :::
